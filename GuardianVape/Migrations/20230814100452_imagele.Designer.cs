...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230814100452_imagele")]
    partial class imagele
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Entities.EqualType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Model.Entities.Condition", b =>
                {
                    b.HasOne("Model.Entities.CollectionType", null)
                        .WithMany("Conditions")
                        .HasForeignKey("CollectionTypeId");
